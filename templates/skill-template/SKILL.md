---
name: my-skill
description: "One-line description of what this skill does and WHEN to use it. Be specific — this is how the agent decides to load it."
version: 0.1.0
author: Your Name
license: MIT
...
metadata:
  hermes:
    tags: [category, keyword, another-keyword]
